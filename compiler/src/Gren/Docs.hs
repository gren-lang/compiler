...
fromModule modul =
  case modul of
    (Can.ImplementationModule _ _ exports docs _ _ _ _ _) ->
      case exports of
...
checkDefs exportDict overview comments (Can.ImplementationModule name _ _ _ decls unions aliases infixes effects) =
